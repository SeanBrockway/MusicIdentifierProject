...
stored_playlists = playlists_col.find({})

for playlist in stored_playlists:

    trackCount = 0
    tracks = sp.playlist_tracks(playlist['playlist_id'], fields=None, limit=None, offset=0, market=None) #API Call to get tracklist for the current playlist
        ...
        if (track['track'] is not None):
            ...
            if (features[0] is not None):
                song_record = { 
                    ...
                    'from_playlist' : playlist['playlist_name'],
                    "genres": genre_arr,
